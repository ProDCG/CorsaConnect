...
WEATHER_OPTIONS: list[WeatherDef] = [
    WeatherDef("12", "Light sleet"),
    WeatherDef("13", "Sleet"),
    WeatherDef("14", "Heavy sleet"),
    WeatherDef("15", "Clear"),
    WeatherDef("16", "Few clouds"),
    WeatherDef("17", "Scattered clouds"),
    WeatherDef("18", "Broken clouds"),
    WeatherDef("19", "Overcast clouds"),
    WeatherDef("20", "Fog"),
    WeatherDef("21", "Mist"),
    WeatherDef("22", "Smoke"),
    WeatherDef("23", "Haze"),
    WeatherDef("24", "Sand"),
    WeatherDef("25", "Dust"),
    WeatherDef("26", "Squalls"),
    WeatherDef("27", "Tornado"),
    WeatherDef("28", "Hurricane"),
    WeatherDef("29", "Cold"),
    WeatherDef("30", "Hot"),
    WeatherDef("31", "Windy"),
    WeatherDef("32", "Hail"),
    WeatherDef("None", "None"),
]
