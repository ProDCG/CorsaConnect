...
WEATHER_OPTIONS: list[WeatherDef] = [
    ...
    WeatherDef("sol_03_scattered_clouds", "Sol 03 Scattered Clouds"),
    WeatherDef("sol_04_windy", "Sol 04 Windy"),
    WeatherDef("sol_05_broken_clouds", "Sol 05 Broken Clouds"),
    WeatherDef("sol_06_overcast", "Sol 06 Overcast"),
    WeatherDef("sol_11_mist", "Sol 11 Mist"),
    WeatherDef("sol_12_fog", "Sol 12 Fog"),
    WeatherDef("sol_21_haze", "Sol 21 Haze"),
    WeatherDef("sol_22_dust", "Sol 22 Dust"),
    WeatherDef("sol_23_sand", "Sol 23 Sand"),
    WeatherDef("sol_24_smoke", "Sol 24 Smoke"),
    WeatherDef("sol_31_light_drizzle", "Sol 31 Light Drizzle"),
    WeatherDef("sol_32_drizzle", "Sol 32 Drizzle"),
    WeatherDef("sol_33_heavy_drizzle", "Sol 33 Heavy Drizzle"),
    WeatherDef("sol_34_light_rain", "Sol 34 Light Rain"),
    WeatherDef("sol_35_rain", "Sol 35 Rain"),
    WeatherDef("sol_36_heavy_rain", "Sol 36 Heavy Rain"),
    WeatherDef("sol_41_light_thunderstorm", "Sol 41 Light Thunderstorm"),
    WeatherDef("sol_42_thunderstorm", "Sol 42 Thunderstorm"),
    WeatherDef("sol_43_heavy_thunderstorm", "Sol 43 Heavy Thunderstorm"),
    WeatherDef("sol_44_squalls", "Sol 44 Squalls"),
    WeatherDef("sol_45_tornado", "Sol 45 Tornado"),
    WeatherDef("sol_46_hurricane", "Sol 46 Hurricane"),
    WeatherDef("sol_51_light_snow", "Sol 51 Light Snow"),
    WeatherDef("sol_52_snow", "Sol 52 Snow"),
    WeatherDef("sol_53_heavy_snow", "Sol 53 Heavy Snow"),
    WeatherDef("sol_54_light_sleet", "Sol 54 Light Sleet"),
    WeatherDef("sol_55_sleet", "Sol 55 Sleet"),
    WeatherDef("sol_56_heavy_sleet", "Sol 56 Heavy Sleet"),
    WeatherDef("sol_57_hail", "Sol 57 Hail"),
]
